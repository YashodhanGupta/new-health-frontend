...
const Dashboard = () => {
  ...
  const doctor = data || {};  // Ensure `doctor` always holds an object
  ...
  return (
    <section>
      <div className='max-w-[1170px] px-5 mx-auto'>
        ...
        {error && !loading && <Error message={error} />} {/* Show error if exists */}
        ...
        <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
          ...
          <div className="lg:col-span-2"> <br />
            ...
            2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                ...
                <span className="ml-2">To get approval please complete your profile. We&apos;ll review
                manually and approve within 3days.</span>
              </div>
            )}
                ...
                <div>
                  <div className='flex items-center gap-4 mb-10'>
                    <figure className='max-w-[200px] max-h-[200px]'>
                      <img
                        src={doctor.photo }  // ✅ Show default if no photo
                        alt="Doctor Profile"
                    ...
                    <div>
                      ...
                      <div className='flex items-center gap-[6px]'>
                        <span className='flex items-center gap-[6px] text-headingColor text-[14px] leading-5 lg:text-[16px] 
