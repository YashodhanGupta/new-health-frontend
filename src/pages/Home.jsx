...
const Home = () => {
  return <>
      ...
      <div className="container">
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] 
                md:leading-[70px]'>
                We help patients live a healthy, longer life.</h1> <br />
          ...
          <div className='flex gap-[40px] justify-end'>
            ...
            <div className='mt-[20px] w-[40%] lg:w-[35%]'>
              <img src={heroImg02} alt="" className='w-full mb-[20px]' />
    ...
    <section>
      <div className="container">
        <div className='lg:w-[470px] mx-auto'> <br /><br />
    ...
    <section>
      <div className="container"> <br /> <br /><br />
        <div className='xl:w-[470px] mx-auto'>
          <h2 className='heading text-center'>Our Medical Services</h2> <br />
    ...
    <section>
      <div className='about__section '> <br /><br />
        <div className='flex items-center justify-between flex-col lg:flex-row'>
          {/*----------feature content------- */}
          <div className='xl:w-[670px] ml-5 lg:ml-10'>
          ...
          <img src={featureImg} className='w-3/4 -translate-x-2 lg:-translate-x-8' alt="" />
    ...
    <section>
      <div className="container"> <br /><br />
        <div className='xl:w-[470px] mx-auto'>
          <h2 className='heading text-center'>Our great doctors</h2> <br />
          <p className='text__para text-center'>World-class care for everyone. Our Health System offers unmatched, expert health care.</p>
        </div>
        <DoctorsList />
      </div>
    ...
    <section>
      <div className='about__section '> <br /><br /><br />
        <div className='flex justify-between gap-[50px] lg:gap-0'>
          <div className='w-1/3 hidden md:block'> {/* Reduced width from w-1/2 to w-1/3 */}
          <img src={faqImg} className="w-full translate-x-2 lg:translate-x-8" alt="" />
    ...
    <section>
      <div className="container"> <br /><br />
        <div className='xl:w-[470px] mx-auto'>
          <h2 className='heading text-center'>What our patients say</h2> <br />
          <p className='text__para text-center'>World-class care for everyone. Our Health System offers unmatched, expert health care.</p>
        </div>
        <Testimonial />
      </div>
